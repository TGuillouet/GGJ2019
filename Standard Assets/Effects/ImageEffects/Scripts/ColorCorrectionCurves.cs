...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorCorrectionCurves : PostEffectsBase
    {
        ...
        ColorCorrectionCurves nightshade;
        Transform playerPos;
        float maxXPose = 0;
        public float gradiantSpeed = 50f;
        ...
        new void Start()
        {
            ...
            nightshade = transform.GetComponent<ColorCorrectionCurves>();
            nightshade.saturation = 0f;
        }
        ...
        void Update()
        {
            if (maxXPose < playerPos.position.x && maxXPose < 100)
            {
                maxXPose = playerPos.position.x;
            }
            nightshade.saturation = (maxXPose/gradiantSpeed);
            if(nightshade.saturation >= 1)
            {
                nightshade.saturation = 1;
            }
        }
